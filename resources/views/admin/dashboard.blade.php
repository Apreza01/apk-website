...
<div class="container py-5">
    ...
    <div class="card h-100 shadow-sm">
        <div class="card-body text-center">
            ...
            <h5 class="card-title">Total Informasi</h5>
            <p class="card-text display-6">{{ $totalInfos }}</p>
        </div>
    </div>
</div>
    ...
    <h2 class="mb-4">Aktivitas Baru</h2>
    <ul class="list-group mb-5">
        ...
        @empty
            <li class="list-group-item text-center">Tidak ada aktivitas terbaru yang ditemukan.</li>
        @endforelse
    </ul>

    <!-- Recent Users Section -->
    <h2 class="mb-4">Pengguna Baru</h2>
    <ul class="list-group mb-5">
        ...
        @empty
            <li class="list-group-item text-center">Tidak ada pengguna terbaru yang ditemukan.</li>
        @endforelse
    </ul>

    <!-- Recent Galleries Section -->
    <h2 class="mb-4">Galeri Baru</h2>
    <ul class="list-group mb-5">
        ...
        @empty
            <li class="list-group-item text-center">Tidak ada galeri terbaru yang ditemukan..</li>
        @endforelse
    </ul>

    <!-- Recent Info Section -->
    <h2 class="mb-4">Informasi Baru</h2>
    <ul class="list-group mb-5">
        ...
        @empty
            <li class="list-group-item text-center">Tidak ada informasi terbaru yang ditemukan..</li>
        @endforelse
    </ul>
